        ...
        <div class="cart-content">
            <div class="cart-content-main" v-for="(item,index) in cartList">
                ...
                <div class="cart-count">
                    <span calss="cart-control-minus" @click="handleCount(index,-1)">-</span>
                    {{item.count}}
                    <span calss="cart-control-add" @click="handleCount(index,1)">+</span>
                </div>
...
<script>
    ...
    export default {
        ...
        computed:{
            cartList(){
                return this.$store.state.b.cartList;
            },
            productDictList(){
                const dict = {};
            ...
            costAll(){
                let cost = 0;
                this.cartList.forEach(item=>{
                    cost +=item.count * this.productDictList[item.id].cost;
                });
                return cost;
            }
        },
